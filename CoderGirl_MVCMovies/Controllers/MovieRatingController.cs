...
namespace CoderGirl_MVCMovies.Controllers
{
    public class MovieRatingController : Controller
    {
        ...
        // The method should redirect to a the GET Action for Details. Be sure to pass the 
        //parameters as route values.

        //Create a GET Action for Details
        // Details should take the parameters passed by the POST Action for Create
        // Details should return a string as Content. This string should be in the format "{moveName} has a 
        //rating of {rating}"
    }
}